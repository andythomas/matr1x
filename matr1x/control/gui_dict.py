...
"""Contains the GuiDict class and its supporting types for control GUIs."""
...
from typing import Any, ClassVar, Protocol, TypeAlias, TypeVar, cast, overload
...
class GuiDict(UserDict[str, var]):
    ...
    def set_cmd_funcs(
        self, window_obj: Any = None, system: System | None = None
    ) -> dict[str, Command]:
        """
    ...
    def _handle_string_setfunc(
        self, name: str, cmd: Command, window_obj: Any
    ) -> tuple[Callable | None, tuple]:
