...
_uncaught_exception_dialog: UncaughtExceptionDialog | None = None


def set_uncaught_exception_dialog(fn: UncaughtExceptionDialog | None) -> None:
    """Register a callback that displays uncaught exceptions.
...
def _show_error_messagebox(
    ...
    """Show the registered dialog (or log) for any uncaught exception."""
    logger.error("Unhandled exception.")
    if _uncaught_exception_dialog is not None:
        _uncaught_exception_dialog(exc_type, exc_value, exc_tb)
    else:
