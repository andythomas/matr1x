...
class Danfysik9100(VisaDevice):
    ...
    def getCurrent(self):
        """
        returns the actual current at the device output in A
        input:
           no input
        output:
           float
    ...
    def getVoltage(self):
        """
        returns the actual voltage at the device output in V
        input:
          no input
        output:
          float
    ...
    def getCurrentSetting(self):
        """
        returns the output current setting value
        input:
          no input
        output:
          float
    ...
    def getVoltageSetting(self):
        """
        returns the output voltage setting value
        input:
          no input
        output:
          float
    ...
    def getPolarityStatus(self):
        """
        returns the current polarity status
        input:
         no input
        output:
         boolean True if ramping, False if stopped
...
class Danfysik9700(Danfysik9100):
    ...
    Additional functions for power supplies with polarity switch unit
    """

    def getCurrent(self):
        """
        Return current based on polarity switch
        """
    ...
    def getCurrentSetting(self):
        """
        Return the setted current based on polarity switch
        """
    ...
    def getVoltage(self):
        """
        Return voltage based on polarity switch
        """
