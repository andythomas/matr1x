...
class PicoVNA(VisaDevice):
    ...
    def configureSweep(self, fStart, fEnd, fPoints,
                       if_bw, average=None):
        """
        ...
        # SENSe<cnum>:BWIDth
        possible_bandwidths = array([10, 50, 100, 500, 1000, 5000, 10000,
                                    15000, 35000, 70000, 140000])
    ...
    def getComplexData(self, param, precision='double'):
        ...
        data = array(list(iter_unpack(">d", data)),
                     dtype=precdict[precision][3]).ravel()
