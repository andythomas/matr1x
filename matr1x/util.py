...
def matrix_script_process(filename, meta_data={}, scriptname="", port=None):
    """
    ...
    if connected is True:
        thread = ExecThread(script, meta_data, scriptname, client_socket, n_pref)
    else:
        thread = ExecThread(script, meta_data, scriptname, None, n_pref)
